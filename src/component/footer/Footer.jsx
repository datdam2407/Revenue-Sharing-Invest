...
const Footer = () => (
    <div className="RSI__footer section__padding">
        ...
        <div className="RSI__footer-links">
            <div className="RSI__footer-links_logo">
                <h4>Giving everyone access to early-stage startup investing <br /> All Rights Reserved</h4>
            </div>
            <div className="RSI__footer-links_div">
                <h2>For investors</h2>
                <hr />
                <a  href='#'>        Why invest</a>
                <a  href='#'>     How it works
        ...
        <div className='RSI_hr-footer'>
        <hr/>
        </div>
        <div className="RSI__footer-copyright">
            <p>Refer a startup, get $2,500</p>
        </div>
       
        <div className='RSI_hr-footer'>
        <hr/>
        </div>
        <div className="RSI__footer-content">
