...
const Invertco = () => {
  ...
  <h3 > <a style={{color:"green"}} href="#"><i class="fa fa-line-chart"></i></a>Most traction in 3 days</h3>
      ...
      <div className="RSI_invertco-container_groupB">
        ...
        <Link to={Title.text}><Title imgUrl={test1} logo={test2} date="Sep 26, 2021" text="First Tokenized Litigation Funding for one of largest US crop destructions" des="First Tokenized Litigation Funding for one of largest US crop destructions" /> </Link>
